...
$LLVM_GNAT/llvm-interface/bin/llvm-gnatlink message.ali -o android/libmessage.so --LINK=$LLD -shared --sysroot=$SYSROOT -L$SYSROOT/usr/lib/aarch64-linux-android
